...
from core.data_utils import class_names_for
from core.utils.adv_utils import map_target_vs_rest
...
def evaluate(
    ...
    for batch in tqdm(test_dl, desc="Evaluating"):
        ...
        if binary_target_idx is None:
            ...
            # Map ground-truth labels to {0:target, 1:negative} to match TargetVsRestLinear output:
            #   logits[:, 0] -> target, logits[:, 1] -> negative.
